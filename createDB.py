...
db.execute("INSERT INTO patient_table(mrn, firstname, lastname, dob) values('12345', 'Jerry', 'Seinfeld', '04/29/1954')")
db.execute("INSERT INTO patient_table(mrn, firstname, lastname, dob) values('23456', 'George', 'Costanza', '09/23/1959')")
db.execute("INSERT INTO patient_table(mrn, firstname, lastname, dob) values('34567', 'Michael', 'Scott', '08/16/1962')")
db.execute("INSERT INTO patient_table(mrn, firstname, lastname, dob) values('45678', 'Jim', 'Halpert', '10/20/1979')")
db.execute("INSERT INTO patient_table(mrn, firstname, lastname, dob) values('56789', 'Thierry', 'Pierre', '07/15/1995')")
